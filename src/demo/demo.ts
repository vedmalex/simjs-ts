...
const model2 = {
	...
	version: "1.0",
	objects: [
		{ type: "source", name: "source_5", out: "monitor_1", model: { lambda: 0.25 } },
		{ type: "source", name: "source_4", out: "monitor_1", model: { lambda: 0.25 } },
		{ type: "source", name: "source_3", out: "monitor_1", model: { lambda: 0.25 } },
		{ type: "source", name: "source_2", out: "monitor_1", model: { lambda: 0.25 } },
		{ type: "source", name: "source_1", out: "monitor_1", model: { lambda: 0.25 } },
		{ type: "monitor", name: "monitor_1", out: "splitter_1" },
		{
			type: "splitter",
			name: "splitter_1",
		...
		{ type: "sink", name: "sink_3", model: null },
		{ type: "sink", name: "sink_2", model: null },
		{ type: "sink", name: "sink_1", model: null },
		{ type: "queue", name: "queue_3", out: "sink_3", model: { nservers: 1, mu: "50" } },
		{ type: "queue", name: "queue_2", out: "sink_2", model: { nservers: 1, mu: "250" } },
		{ type: "queue", name: "queue_1", out: "sink_1", model: { nservers: 1, mu: "100" } },
	],
};
