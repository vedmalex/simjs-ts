...
test('testRandomPython', () => {
  const seed1234 = [0.96645353569213877, 0.44073259917535268,
...
test('testExponentialPython', () => {
  ...
  const seed1234_05 = [0.068244112607034252, 1.6386338770334943,
...
test('testGaussianPython', () => {
  // mu = 1.0, sigma = 0.5
  const seed1234_1_05 = [1.5271098209636194, 0.88722137212465679,
...
test('testParetoPython', () => {
  // alpha = 0.5
  const seed1234_05 = [888.60037609781762, 3.1971351047794356,
...
test('testTriangularPython', () => {
  const seed1234 = [0.87048848640398568, 0.46943189025424797,
...
test('testWeibullPython', () => {
  // alpha = 1.0, beta = 0.5
  const seed1234_1_05 = [11.524828679722953, 0.33770924624900073,
...
test('testGamma', () => {
  ...
  const seed1234_10_10 = [0.034122056303517126, 0.81931693851674714,
  ...
  const seed1234_14_10 = [0.036673975980018911, 0.10711224469034528,
